<!-- Provenance:
  upstream: ce@3.8.3 references/tier-browser-reel.md
  ...
  modifications:
    - athanor v0.11.7: appended an honest annotation to the "/ce-setup" reference
      (~line 23) noting that `/ce-setup` was removed in athanor v0.11.2.
