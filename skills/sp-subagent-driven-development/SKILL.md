...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `subagent-driven-development` → `sp-subagent-driven-development` to match athanor namespace-prefixed directory (`skills/sp-subagent-driven-development/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
