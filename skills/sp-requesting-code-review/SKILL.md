...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `requesting-code-review` → `sp-requesting-code-review` to match athanor namespace-prefixed directory (`skills/sp-requesting-code-review/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
