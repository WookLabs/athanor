...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `dispatching-parallel-agents` → `sp-dispatching-parallel-agents` to match athanor namespace-prefixed directory (`skills/sp-dispatching-parallel-agents/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
