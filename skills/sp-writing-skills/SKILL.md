...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `writing-skills` → `sp-writing-skills` to match athanor namespace-prefixed directory (`skills/sp-writing-skills/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
