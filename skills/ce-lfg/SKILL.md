...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `lfg` → `ce-lfg` to match athanor namespace-prefixed directory (`skills/ce-lfg/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
