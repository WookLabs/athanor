...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `receiving-code-review` → `sp-receiving-code-review` to match athanor namespace-prefixed directory (`skills/sp-receiving-code-review/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
