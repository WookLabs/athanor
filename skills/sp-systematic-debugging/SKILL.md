...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `systematic-debugging` → `sp-systematic-debugging` to match athanor namespace-prefixed directory (`skills/sp-systematic-debugging/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
