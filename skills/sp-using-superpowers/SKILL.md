...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `using-superpowers` → `sp-using-superpowers` to match athanor namespace-prefixed directory (`skills/sp-using-superpowers/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
