...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `writing-plans` → `sp-writing-plans` to match athanor namespace-prefixed directory (`skills/sp-writing-plans/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
