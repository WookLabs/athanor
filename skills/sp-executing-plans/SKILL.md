...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `executing-plans` → `sp-executing-plans` to match athanor namespace-prefixed directory (`skills/sp-executing-plans/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
