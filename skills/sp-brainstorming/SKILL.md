...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `brainstorming` → `sp-brainstorming` to match athanor namespace-prefixed directory (`skills/sp-brainstorming/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
