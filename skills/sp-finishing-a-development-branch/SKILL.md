...
<!-- Provenance:
  upstream: superpowers@5.1.0 SKILL.md
  ...
  modifications: frontmatter `name:` rewritten `finishing-a-development-branch` → `sp-finishing-a-development-branch` to match athanor namespace-prefixed directory (`skills/sp-finishing-a-development-branch/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
