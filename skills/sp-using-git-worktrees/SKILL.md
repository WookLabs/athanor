...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `using-git-worktrees` → `sp-using-git-worktrees` to match athanor namespace-prefixed directory (`skills/sp-using-git-worktrees/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
