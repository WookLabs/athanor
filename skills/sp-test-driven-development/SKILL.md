...
<!-- Provenance:
  ...
  modifications: frontmatter `name:` rewritten `test-driven-development` → `sp-test-driven-development` to match athanor namespace-prefixed directory (`skills/sp-test-driven-development/`). Body content otherwise verbatim. Provenance block inserted after frontmatter.
  t0-t1-disproof:
