...
def test_marketplace_version_in_current_series():
    """MUST: marketplace.json plugin version is in the 0.10.x / 0.11.x / 0.12.x / 0.13.x / 0.14.x / 0.15.x / 0.16.x / 0.17.x / 0.18.x / 0.19.x / 0.20.x / 0.21.x / 0.22.x / 0.23.x / 0.24.x / 0.25.x series.
    ...
    extended to include 0.25.x at v0.25.0 (Windows hook launcher +
    PreToolUse precision hardening).
    """
    import json
    mp = json.loads(
    ...
    in_series = [v for v in versions
                 if v and (
                     ...
                     or v.startswith("0.15.")
                        ...
                        or v.startswith("0.25.")
                     )]
    assert in_series, (
        f"marketplace.json plugin version must be in 0.10.x / 0.11.x / 0.12.x / 0.13.x / 0.14.x / 0.15.x / 0.16.x / 0.17.x / 0.18.x / 0.19.x / 0.20.x / 0.21.x / 0.22.x / 0.23.x / 0.24.x / 0.25.x series; "
        f"got {versions}"
    )
...
def test_plugin_manifest_version_matches_marketplace():
    ...
    assert pj_version and (
        ...
        or pj_version.startswith("0.15.")
            ...
            or pj_version.startswith("0.25.")
        ), (
            f"plugin.json version must be in 0.10.x / 0.11.x / 0.12.x / 0.13.x / 0.14.x / 0.15.x / 0.16.x / 0.17.x / 0.18.x / 0.19.x / 0.20.x / 0.21.x / 0.22.x / 0.23.x / 0.24.x / 0.25.x series; "
            f"got {pj_version!r}"
        )
