...
def test_state_md_current_phase_in_0_10_or_0_11_or_0_12_or_0_13_or_0_14_or_0_15_or_0_16_x_series():
    ...
    0.13.x / 0.14.x / 0.15.x / 0.16.x / 0.17.x / 0.18.x / 0.19.x / 0.20.x / 0.21.x / 0.22.x / 0.23.x / 0.24.x version.
    ...
    assert in_series, (
        "Current Phase must reference a 0.10.x / 0.11.x / 0.12.x / 0.13.x / 0.14.x / 0.15.x / 0.16.x / 0.17.x / 0.18.x / 0.19.x / 0.20.x / 0.21.x / 0.22.x / 0.23.x / 0.24.x version"
    )
