...
2. Step 2 work
   ...
   - tests_modified: true
   - test_paths_touched: [tests/test_regression_v013_lfg_goal_skill_contract.py]
...
- G1: closed
  - closed_by: C001
  - evidence_refs:
    - tests/test_regression_v013_lfg_goal_skill_contract.py
    - tests/test_regression_v013_lfg_goal_receipt_contract.py
