"""Regression tests for the lfg-goal adaptive controller model."""
...
def _state(**overrides) -> LoopState:
    data = {
        ...
        "last_receipt_path": ".athanor/goals/36470e54/receipts/C001-lfg-receipt.md",
...
def _evidence(**overrides) -> EvidenceSummary:
    data = {
        ...
        "progress_made": True,
        "references": [".athanor/goals/36470e54/receipts/C001-lfg-receipt.md"],
