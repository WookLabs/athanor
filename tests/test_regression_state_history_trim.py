...
def test_state_md_keeps_recent_phases() -> None:
    ...
    # The pinned set slides with the trim window: v0.22.0 rotates v0.21.0 into
    # Previous and archives the oldest surplus (v0.18.8), so the live Previous
    # phases are now v0.21.0, v0.20.1, v0.20.0, v0.19.3, v0.19.2.
    for v in ("v0.21.0", "v0.20.1", "v0.19.2"):
